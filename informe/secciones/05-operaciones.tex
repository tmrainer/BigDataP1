...
Cada consulta se acompaña de la captura de su ejecución en el entorno de JupyterLab del clúster. Las capturas corresponden a la implementación en Polars por ser la de salida más legible; la Sección~\ref{sec:rendimiento} incluye las evidencias equivalentes de Dask, Modin y Apache Spark. El código fuente completo de las cuatro herramientas se entrega por separado, fuera de este informe.
