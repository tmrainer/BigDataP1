...
Palabras procesadas (\texttt{Map output records})& 773,268 \\
Bytes leídos (\texttt{Bytes Read})               & 2,206,115 \\
Total de caracteres (\texttt{length} en HDFS)    & 3,436,884 \\
Total de palabras (\texttt{count} en HDFS)       & 773,268 \\
...
El contenido crudo almacenado en HDFS permite verificar el cálculo a mano: $3{,}436{,}884 \div 773{,}268 = 4.4446$, que coincide con el valor \texttt{4.444622045655581} impreso en consola.
...
Los cinco \textit{scripts} completos de esta práctica (creación del clúster, los tres programas y su eliminación) se entregan en el paquete de código fuente.
